...
Copy-paste these prompts into each terminal to initialize your agents.

---

## Terminal 1: Agent-Core (Core Layer Engineer)
...
## Terminal 2: Agent-Audio (Audio Engine Engineer)
...
## Terminal 3: Agent-Plugins (Plugin System Engineer)
...
1. Open 3 separate terminals in VS Code
2. In each terminal, navigate to the blooper5 directory
3. Copy-paste the appropriate prompt into each terminal
4. Each agent will read their assignment and begin work

The agents will coordinate through the `.agent-coordination/` files and make pull requests when done.

You (the user) will act as project manager, reviewing PRs and merging them.
